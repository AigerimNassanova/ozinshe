...
class AnimatedSeriesItemAdapter(): RecyclerView.Adapter<AnimatedSeriesItemAdapter.NewProjectsViewHolder>() {
    ...
    inner class NewProjectsViewHolder(private var binding: AdapterRcTrendsItemBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewProjectsViewHolder {
        return NewProjectsViewHolder(
    ...
    override fun onBindViewHolder(holder: NewProjectsViewHolder, position: Int) {
