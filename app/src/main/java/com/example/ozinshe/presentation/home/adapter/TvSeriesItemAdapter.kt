...
class TvSeriesItemAdapter(): RecyclerView.Adapter<TvSeriesItemAdapter.MoviesByCategoryHolder>() {
    ...
    inner class MoviesByCategoryHolder(private var binding: AdapterRcTrendsItemBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MoviesByCategoryHolder {
        return MoviesByCategoryHolder(
    ...
    override fun onBindViewHolder(holder: MoviesByCategoryHolder, position: Int) {
